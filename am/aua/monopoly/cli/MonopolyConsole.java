...
//                        Dice.checkSpeeding();
                ...
                monopoly.print(Monopoly.railroadChecker(player));

                System.out.println("Choose the property e.g 1, 2, 3");
                int property = scanner.nextInt();
                if (property <= Monopoly.railroadChecker(player).size()) {
                    try {
                        monopoly.teleport(player, Monopoly.railroadChecker(player).get(property - 1));
