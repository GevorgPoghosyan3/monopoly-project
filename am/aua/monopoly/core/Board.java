...
public class Board {
    ...
    /**
     * Initializes the game board with properties and special tiles.
     */
     ...
     *
     * @param p The position of the tile to retrieve.
    ...
    /**
     * Retrieves the property at the specified position on the board.
     *
     * @param p The position of the property to retrieve.
     * @return The property at the specified position, or null if no property exists.
     */
