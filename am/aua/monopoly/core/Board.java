...
public class Board {
    ...
    public void initializeBoard() {
        ...
        tiles.add(new Property("Railroad", 200, 50, 0, 0, 0, 0, Property.PropertyType.RAILROAD, false));  // 5
        ...
        tiles.add(new Tile("Free Parking"));  // 20
